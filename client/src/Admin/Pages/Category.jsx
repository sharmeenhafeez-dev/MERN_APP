  ...
  return (
    <div>
      ...
      <div className='d-flex flex-column flex-lg-row align-items-lg-center justify-content-between mt-3'>
        <h2 className='mb-3 mb-lg-0 p-3'>Category</h2>
        <AddCategory recallData={setCategory} />
      </div>
        ...
        <table className='table'>
          <thead>
            <tr style={{ backgroundColor: 'peachpuff' }}>
              ...
              <th scope='col' className='bg-dark text-white'>Category Name</th>
              <th scope='col' className='bg-dark text-white'>Category Image</th>
